    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(
            builder: (context) =>
                MainContainer(userName: name, email: loginEmail, role: role),
          ),
        );
      } else {
        ...
        children: [
          HomePage(
            ...
            onBookNow: (movie) => Navigator.push(
              ...
              MaterialPageRoute(
                builder: (_) =>
                    SeatSelectionPage(movie: movie, onConfirm: _goToTicket),
              ),
            ),
          ),
          const SearchPage(),
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                border: Border(
                  bottom: BorderSide(color: TC.accent.withOpacity(0.15)),
                ),
              ),
              child: Row(
                children: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: TC.accent.withOpacity(0.7),
                                blurRadius: 14,
                                spreadRadius: 2,
                              ),
                            ],
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: TC.bg,
                border: Border(
                  top: BorderSide(color: TC.accent.withOpacity(0.15)),
                ),
              ),
              child: Column(
                children: [
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: TC.accent.withOpacity(0.18)),
                      ),
                      child: Row(
                        children: [
                          ClipRRect(
                    ...
                    _payOpt(
                      ...
                      title: 'Cash',
                      sub: 'Bayar langsung di loket bioskop',
                    ),
                    const SizedBox(height: 10),
                    _payOpt(
                      id: 'ewallet',
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          _feeRow(
                            'Tickets',
                            '${widget.selectedSeats.length} x \$${widget.ticketPrice.toStringAsFixed(2)}',
                          ),
                          const SizedBox(height: 10),
                          _feeRow(
                            'Subtotal',
                          ...
                          _feeRow(
                            'Convenience Fee',
                            '\$${widget.convFee.toStringAsFixed(2)}',
                          ),
                          const SizedBox(height: 14),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: sel ? TC.accent : TC.surface,
            width: sel ? 1.5 : 1,
          ),
        ),
        child: Row(
          children: [
            ...
            AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: sel ? TC.accent : TC.textHint,
                  width: 1.5,
                ),
              ),
              child: sel
          ...
          ? const Center(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 6),
                  Text(
                    'Book a movie to get your tickets here.',
                    style: TextStyle(color: TC.textSec, fontSize: 13),
                  ),
                ],
              ),
...
class _TicketCard extends StatelessWidget {
  ...
  Widget _info(String label, String value, {Color? valueColor}) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Text(
        label,
